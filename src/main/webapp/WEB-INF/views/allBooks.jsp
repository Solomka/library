		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel"><fmt:message key="library.book.searchByTitle" bundle="${rb}" /></h4>
				</div>
				<div class="modal-body">
					<form action="./searchBookByTitle" method="POST" role="form">

						<div class="form-group">
							<label for="title"><fmt:message key="library.title" bundle="${rb}" /></label> <input type="text"
								class="form-control" id="title" name="title" />
						</div>

						<div class="modal-footer">
							<button type="submit" class="btn btn-default" id="submitButton"><fmt:message key="library.search" bundle="${rb}" /></button>
						</div>
					</form>
				</div>
